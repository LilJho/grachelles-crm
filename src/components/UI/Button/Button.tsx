...
const ColorSubtle = (color = "default") => {
  switch (color) {
    ...
    case "blue":
      return "border-white bg-white text-indigo-400 hover:text-indigo-500 active:text-indigo-600";
    case "yellow":
      return "border-white bg-white text-green-400 hover:text-green-500 active:text-green-600";
    case "red":
      return "border-white bg-white text-rose-400 hover:text-rose-500 active:text-rose-600";
    case "gray":
      return "border-white bg-white text-gray-400";
    default:
      break;
  }
};
